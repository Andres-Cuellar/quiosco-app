  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 hover:bg-sky-800 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full"
        ...
        <button
          type="button"
          className="bg-red-700 hover:bg-red-800 flex px-5 gap-2 mt-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full"
